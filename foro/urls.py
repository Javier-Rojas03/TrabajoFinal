...
urlpatterns = [
    ...
    path('creacion/videojuego/', creacion_videojuego.as_view(), name='creacion_videojuego'),
    ...
    path('videojuegos/<int:pk>/modificar/', modificar_blog_videojuego.as_view(), name='modificar_blog_videojuego'),
